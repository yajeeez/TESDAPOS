...
try {
    ...
    // Update admin password to the latest email password
    $result = $adminsCollection->updateOne(
        ['email' => 'yajeee1209@gmail.com'],
        ['$set' => ['password' => 'lg9DePw8']]  // New password from email
    );
    
    echo json_encode([
        'success' => $result->getModifiedCount() > 0,
        'message' => $result->getModifiedCount() > 0 ? 'Admin password updated to lg9DePw8' : 'No changes made',
